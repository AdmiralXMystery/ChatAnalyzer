...
DEFAULT_ERROR_WHITELIST = [
    # Мессенджеры, соцсети и форматы
    'вк', 'тг', 'лк', 'лс', 'акк', 'паблик', 'чат', 'медиа', 'юзер',
    'телеграм', 'телега', 'инста', 'ютуб', 'видос', 'скрин', 'голосовое', 'гс',
    # Вежливые слова и частые сокращения
    'спс', 'плз', 'плиз', 'дд', 'дв', 'нз', 'бб', 'ку', 'прив', 'кнш', 'хах', 'Хах', 'кста',
    'всм', 'смысле', 'ща', 'щас', 'лан', 'ладно', 'крч', 'кароче', 'типа', 'типо', 'пздц',
    'пон', 'днс', 'екб', 'екат', 'мск', 'спб', 'чито', 'дыа', 'кст', 'збс', 'кароч', 'погодь',
    'капец', 'пипец', 'писец', 'дарова', 'мейби',
    # Учеба, экзамены и работа
    'огэ', 'егэ', 'вуз', 'препод', 'дз', 'гдз', 'курсач', 'оффлайн', 'онлайн',
    'дедлайн'
    # Гейминг, ИТ и интернет-сленг
    'пк', 'комп', 'гамать', 'катка', 'тима', 'ранг', 'лвл', 'скилл', 'нуб', 'про',
    'чит', 'бан', 'ливнуть', 'краш', 'крашнулся', 'баг', 'фича', 'апнуть', 'фулл'
    'стрим', 'донат', 'видос', 'гайд', 'хз', 'имхо', 'рил', 'рофл', 'пабг', 'пабга',
    'треш', 'трэш', 'кринж', 'вайб', 'жиза', 'форсить', 'хейт', 'абьюз', 'чел', 'слив',
    'видюха', 'пк', 'комп'
]

DEFAULT_PROFANITY_BLACKLIST = [
    'сука', 'падла', 'тварь', 'урод', 'сучка', 'дурак', 'придурок', 'дебил', 'скотина', 'чмо',
    'лох', 'говно', 'гнида', 'бестолочь', 'болван', 'профан', 'тупица', 'идиот', 'жопа', 'лошара', 'вонючка',
]
